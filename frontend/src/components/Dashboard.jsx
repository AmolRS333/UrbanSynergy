...
const [user, setUser] = useState({ name: "" });
  ...
  return (
    <div className='bg-zinc-800'>
        ...
        {card.map((item, index) => (
          <div key={index} className="bg-zinc-50 p-4  rounded">
            <div className=" flex justify-between items-center ">
              ...
              <div className="m-2 text-2xl bg-amber-200 p-2 rounded-full">
                {item.icon}
              </div>
            </div>
      ...
      <div className=" mt-10">
        <table className="min-w-full  bg-zinc-100 rounded-2xl shadow">
          <thead>
            <tr>
          ...
          <tbody>
            {[
              ...
              <tr key={idx} className="border-t bg-zinc-100 border-zinc-200">
